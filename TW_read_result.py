...
# pv.global_theme.font.family = 'helvetica'
pv.global_theme.font.size = 7
...
for i in range(5):
    ...
    # plt.figure()
    # plt.plot(result_df['pos_r_Rs'], result_df['omega_i_Hz'])
    # plt.show()
...
p.add_mesh(box_grid.slice(normal=[0,0,1]),clim=[-22,-15],cmap='jet',opacity=0.5,show_scalar_bar=True)
p.add_mesh(sun_sphere, scalars='Br',cmap='seismic',clim=[-1.,1.],show_scalar_bar=True)
p.show_axes()
